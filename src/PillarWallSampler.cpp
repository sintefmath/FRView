...
template class PillarWallSampler< PolygonTessellator<GridTessBridge> >;
template PillarWallSampler< PolygonTessellator<GridTessBridge> >::PillarWallSampler<float>( const float*, const float*);
