...
#define CHUCK( A, B, C ) case B: static const string A = C; return A; break
    ...
    CHECK( FLOOILIP, KEYWORD_FLOOILIP );
    CHECK( FLOOILJP, KEYWORD_FLOOILJP );
    CHECK( FLOOILKP, KEYWORD_FLOOILKP );
    CHECK( FLOGASIP, KEYWORD_FLOGASIP );
    CHECK( FLOGASJP, KEYWORD_FLOGASJP );
    CHECK( FLOGASKP, KEYWORD_FLOGASKP );
    CHECK( FLOWATIP, KEYWORD_FLOWATIP );
    CHECK( FLOWATJP, KEYWORD_FLOWATJP );
    CHECK( FLOWATKP, KEYWORD_FLOWATKP );
