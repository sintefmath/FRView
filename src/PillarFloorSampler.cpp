...
template class PillarFloorSampler< PolygonTessellator<GridTessBridge> >;
template PillarFloorSampler< PolygonTessellator<GridTessBridge> >::PillarFloorSampler<float>( const float*, const float*, const float*, const float*);
