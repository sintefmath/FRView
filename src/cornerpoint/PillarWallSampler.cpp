...
template class PillarWallSampler< bridge::PolyhedralMeshBridge >;
template PillarWallSampler< bridge::PolyhedralMeshBridge >::PillarWallSampler( const float*, const float*);
